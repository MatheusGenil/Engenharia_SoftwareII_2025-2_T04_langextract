...
# =====================================================
# Inicializa o modelo QA (menor e mais rápido)
# =====================================================
#pode trocar por:
...
# =====================================================
# Clona o repositório LangExtract e lê o README
# =====================================================
...
# =====================================================
# Filtra conteúdo relevante (reduz contexto)
# =====================================================
...
print(f"📄 Contexto filtrado: {len(contexto_relevante)} caracteres\n")

# =====================================================
# Contexto adicional de apoio semântico
# =====================================================
contexto_extra = """
...
# =====================================================
# Executa QA (com seleção da melhor resposta)
# =====================================================
